...
def _cmd_query(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        print("\n==================================================")
        print(f"🌦️  WeatherWise CLI — {loc_label}")
        print("==================================================")
        print(f"📢 Headline:   {headline}")
        print(f"🌡️  Live Temp:  {live['temperature_c']}°C (Feels like: {feels_like}°C)")
...
def _cmd_health(args: argparse.Namespace) -> int:
    ...
    print(f"Hugging Face:       {'✅ CONFIGURED' if settings.hf_api_key else '⚠️ FALLBACK (Deterministic engine)'}")
